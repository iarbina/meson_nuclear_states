...
# Plot----------------------------------------------------------------	
	...
	for i in range(len(A1)):
		...
		#ax.scatter(AA3[i], BB3[i], color='C'+str(i))
		ax.scatter(AA4[i], BB4[i], color='C'+str(i))
		ax.scatter(AA5[i], BB5[i], color='C'+str(i))
	...
	for i in range(len(A1)):
		...
		#ax2.scatter(AA3[i], GG3[i], color='C'+str(i))
		ax2.scatter(AA4[i], GG4[i], color='C'+str(i))
		ax2.scatter(AA5[i], GG5[i], color='C'+str(i))
	...
	plt.text(AA1[0]+xstep, GG4[0]+ystep, r'C')
	plt.text(AA1[1]+xstep, GG4[1]+ystep, r'Mg')
