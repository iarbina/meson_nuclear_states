...
#----------------------------------------------------------------------
	...
	datafile1 = "K_mares.dat"
	Z1, A1, B1, G1 = reading(datafile1, 5)
	
	datafile2 = "K_ours.dat"
...
# Plot----------------------------------------------------------------	
	...
	plt.text(AA1[4]+xstep, BB1[4]+ystep-0.5, r'Pb')
	...
	ax2.set_ylabel(r"$\Gamma_{K^0}$ (MeV)")
	ax2.set_xlim(0,40)
	ax2.set_ylim(70,90)
	ax2.yaxis.set_major_locator(MaxNLocator(integer=True))
	ax2.tick_params(which='both',direction='in',top=True,right=True)
	ax2.legend(loc='lower right')
	plt.text(AA1[0]+xstep, GG2[0]+ystep-0.5, r'C')
	plt.text(AA1[1]+xstep-1.0, GG1[1]+ystep+1.0, r'Mg')
