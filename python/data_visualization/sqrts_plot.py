...
#----------------------------------------------------------------------
	...
	ax.plot(sqrts00-Eth, tKN(tpr00, tnr00), pt1, markersize = ps1, label = r"$0.00 \rho_0$")
	ax.plot(sqrts025-Eth, tKN(tpr025, tnr025), pt1, markersize = ps1, label = r"$0.25 \rho_0$")
	ax.plot(sqrts05-Eth, tKN(tpr05, tnr05), pt1, markersize = ps1, label = r"$0.50 \rho_0$")
	ax.plot(sqrts075-Eth, tKN(tpr075, tnr075), pt1, markersize = ps1, label=r"$0.75 \rho_0$")
	ax.plot(sqrts10-Eth, tKN(tpr10, tnr10), pt1, markersize = ps1, label=r"$1.00 \rho_0$")
	...
	ax2.plot(sqrts00-Eth, tKN(tpi00, tni00), pt2, markersize = ps2, label = r"$0.00 \rho_0$")
	ax2.plot(sqrts025-Eth, tKN(tpi025, tni025), pt2, markersize = ps2, label = r"$0.25 \rho_0$")
	ax2.plot(sqrts05-Eth, tKN(tpi05, tni05), pt2, markersize = ps2, label = r"$0.50 \rho_0$")
	ax2.plot(sqrts075-Eth, tKN(tpi075, tni075), pt2, markersize = ps2, label = r"$0.75 \rho_0$")
	ax2.plot(sqrts10-Eth, tKN(tpi10, tni10), pt2, markersize = ps2, label = r"$1.00 \rho_0$")
	...
	ax3.plot(sqrts00-Eth, TKN2(tpr00, tpi00, tnr00, tni00), pt2, markersize = ps2, label = r"$0.00 \rho_0$")
	ax3.plot(sqrts025-Eth, TKN2(tpr025, tpi025, tnr025, tni025), pt2, markersize = ps2, label = r"$0.25 \rho_0$")
	ax3.plot(sqrts05-Eth, TKN2(tpr05, tpi05, tnr05, tni05), pt2, markersize = ps2, label = r"$0.50 \rho_0$")
	ax3.plot(sqrts075-Eth, TKN2(tpr075, tpi075, tnr075, tni075), pt2, markersize = ps2, label = r"$0.75 \rho_0$")
	ax3.plot(sqrts10-Eth, TKN2(tpr10, tpi10, tnr10, tni10), pt2, markersize = ps2, label = r"$1.00 \rho_0$")
